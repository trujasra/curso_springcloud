...
import com.trujasra.springcloud.msvc.cursos.clients.UsuarioClientRest;
...
import com.trujasra.springcloud.msvc.cursos.models.entity.CursoUsuario;
    ...
    public Optional<Curso> porIdConUsuarios(Long id) {
        ...
        if (o.isPresent()) {
            ...
            if (!curso.getCursoUsuarios().isEmpty()) {
                ...
                List<Usuario> usuarios = cliente.obtenerAlumnosPorCursos(ids);
